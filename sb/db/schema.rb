...
ActiveRecord::Schema.define(version: 2021_07_01_061207) do
  ...
  create_table "accs_hosho_masters", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "アクセス保証開始情報", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["client_no", "customer_no"], name: "IDX_ACS_HSO_KG"
  ...
  create_table "accs_sinsa_kekkas", primary_key: "ID", id: :integer, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "アクセス審査結果", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["client_code", "corporate_code"], name: "IDX_ACS_SK_KG"
    t.index ["corporate_code"], name: "IDX_ACCS_SK"
    t.index ["shinsa_code"], name: "IDX_ACS_SK_CD"
  end
  ...
  create_table "alarm_candidates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "アラーム情報の候補", force: :cascade do |t|
    ...
    t.string "association_code_1", limit: 4, comment: "関連付けコード１"
    t.string "association_code_2", limit: 4, comment: "関連付けコード２"
  ...
  create_table "alarms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "アラーム情報", force: :cascade do |t|
    ...
    t.text "text_extraction_value", comment: "本文自体を保持"
    t.text "text_extraction_word_set", comment: "カンマ区切りwordセット（名詞、動詞、形容詞）"
    t.index ["alarm_level"], name: "idx_as_al"
    t.index ["created_at"], name: "idx_as_c"
  ...
  create_table "by_budgets", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "BY予算", force: :cascade do |t|
    t.integer "agent_type", null: false, comment: "取次店区分    1:一般・共同商品、2:再保証"
  ...
  create_table "by_customer_urls", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "BY申込人URL", force: :cascade do |t|
  ...
  create_table "by_examination_urls", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "BY申込人調査URL", force: :cascade do |t|
  ...
  create_table "by_thing_urls", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "BY物件URL", force: :cascade do |t|
  ...
  create_table "by_things", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "BY物件", force: :cascade do |t|
    ...
    t.date "approval_date", comment: "決裁日"
  ...
  create_table "companyinfo_entity_delete_lists", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "companyinfo用entity非表示リスト", force: :cascade do |t|
    t.integer "entity_id", null: false, comment: "entity_id"
    t.boolean "delete_flag", default: true, comment: "削除フラグ"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["entity_id"], name: "entity_id", unique: true
  end

  create_table "companyinfo_task_es_updates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "companyinfo用EntitiesテーブルEs更新バッチ履歴", force: :cascade do |t|
    t.datetime "started_at", null: false, comment: "開始日時"
    t.datetime "ended_at", comment: "Entity更新終了日時"
    t.integer "record_count", comment: "Entity更新件数"
    t.integer "delete_record_count", comment: "Elasticsarch削除件数"
    t.integer "update_record_count", comment: "Elasticsarch更新件数"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
  end
  ...
  create_table "corporate_registration_histories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "法人登記情報変更履歴(変更後の値)", force: :cascade do |t|
    t.integer "entity_id", null: false, comment: "エンティティID"
    t.integer "process", null: false, comment: "処理区分"
    t.datetime "change_date", null: false, comment: "変更年月日"
    ...
    t.integer "prefecture_code", comment: "都道府県コード"
    t.string "address", comment: "住所"
    t.datetime "close_date", comment: "登記記録の閉鎖等年月日"
    t.text "close_cause", comment: "登記記録の閉鎖等の事由"
    t.string "successor_corporate_number", comment: "承継先法人番号"
    t.text "change_cause", comment: "変更事由の詳細"
    t.datetime "api_update_date", comment: "更新年月日(法人APIに登録された日)"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["entity_id", "updated_at"], name: "IDX_CRH_EI_UPDATED_AT"
  end
  ...
  create_table "crawler_filter_words", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "ID", force: :cascade do |t|
    t.integer "customer_master_id", null: false, comment: "取引先マスターID"
    t.boolean "is_remove_filter", default: false, null: false, comment: "除外フラグ 0:除外しない 1:除外する"
    t.boolean "is_priority_filter", default: false, null: false, comment: "優先フラグ 0:優先しない 1:優先する"
    t.string "word", limit: 128, null: false, comment: "フィルター対象とする文字列"
    t.index ["customer_master_id"], name: "fk_cfw_customer_master_id"
  end
  ...
  create_table "customers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "取引先", force: :cascade do |t|
    ...
    t.datetime "alarm_investigate_limit", default: "2000-01-01 00:00:00", null: false, comment: "過去調査有効期限"
    t.datetime "alarm_investigate_before_limit", comment: "過去調査有効期限(閲覧期限解除前)"
    t.index ["customer_master_id"], name: "idx_cs_cmi"
    t.index ["member_id", "delete_flag"], name: "idx_cs_md"
  ...
  create_table "entity_task_es_updates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "EntitiesテーブルEs更新バッチ履歴", force: :cascade do |t|
    ...
    t.integer "entity_profile_create_count", comment: "EntityProfile新規作成件数"
    t.integer "entity_profile_update_count", comment: "EntityProfile更新件数"
  ...
  create_table "fixed_days", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "固定日", force: :cascade do |t|
    t.integer "fix_type", null: false, comment: "種別\t1:祝日"
    t.date "target_date", null: false, comment: "対象日"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["fix_type", "target_date"], name: "IDX_FIX_DAY"
  end
  ...
  create_table "oauth_access_grants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "resource_owner_id", null: false, comment: "リソースオーナーID"
    t.bigint "application_id", null: false, comment: "アプリケーションID"
    t.string "token", null: false, comment: "トークン"
    t.integer "expires_in", null: false, comment: "有効時間（秒）"
    t.text "redirect_uri", null: false, comment: "リダイレクトURI"
    t.datetime "created_at", null: false, comment: "作成日時"
    t.datetime "revoked_at", comment: "更新日時"
    t.string "scopes", null: false, comment: "スコープ"
  ...
  create_table "oauth_access_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "resource_owner_id", comment: "リソースオーナーID"
    t.bigint "application_id", null: false, comment: "アプリケーションID"
    t.string "token", null: false, comment: "トークン"
    t.string "refresh_token", comment: "リフレッシュトークン"
    t.integer "expires_in", comment: "有効時間（秒）"
    t.datetime "revoked_at", comment: "取消日時"
    t.datetime "created_at", null: false, comment: "作成日時"
    t.string "scopes", comment: "スコープ"
    t.string "previous_refresh_token", default: "", null: false, comment: "前回リフレッシュトークン"
  ...
  create_table "oauth_applications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "name", null: false, comment: "アプリケーション名"
    t.string "uid", null: false, comment: "アプリケーションID"
    t.string "secret", null: false, comment: "クライアントシークレット"
    t.text "redirect_uri", null: false, comment: "リダイレクトID"
    t.string "scopes", null: false, comment: "スコープ"
    t.boolean "confidential", default: true, null: false, comment: "機密フラグ"
    t.datetime "created_at", null: false, comment: "作成日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.integer "owner_id", comment: "アプリケーションオーナーID"
    t.string "owner_type", comment: "アプリケーションオーナータイプ（型）"
  ...
  create_table "sb_exam_requests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "ＳＢ審査依頼情報", force: :cascade do |t|
    t.integer "customer_id", comment: "取引先ID"
    t.string "client_code", limit: 11, null: false, comment: "クライアントコード"
    t.string "outside_id", limit: 20, null: false, comment: "外部ID"
    t.string "corporation_name", limit: 200, null: false, comment: "法人名"
    t.string "corporation_number", limit: 13, comment: "法人番号"
    t.string "house_company_code", comment: "内部企業コード"
    t.integer "pref_code", comment: "都道府県コード"
    t.string "address", comment: "住所"
    ...
    t.string "tel", limit: 11, comment: "電話番号"
    t.string "product", comment: "商品"
    t.string "payment_site", limit: 20, comment: "支払サイト"
    t.string "transaction_history", limit: 20, comment: "取引歴"
    t.string "delay_exist", limit: 1, comment: "遅延有無"
    t.string "delay_content", limit: 100, comment: "遅延内容"
    t.string "cond_change_exist", limit: 1, comment: "決済条件変更有無"
    t.string "cond_change_content", limit: 100, comment: "決済条件変更内容"
    t.string "client_memo", limit: 200, comment: "先方連絡"
    t.integer "desired_amount_ref", comment: "参考希望額"
    t.integer "desired_amount", comment: "希望額"
    t.integer "other_amount", comment: "他社保証枠"
    t.date "request_date", comment: "依頼日"
    t.date "invoice_date", comment: "請求書発行日"
    t.date "payment_date", comment: "支払日"
    t.string "status", limit: 1, comment: "状態"
    t.text "memo", comment: "メモ"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["client_code"], name: "IDX_SER_CLT_CD"
    t.index ["corporation_name"], name: "IDX_SER_CORP_NM"
    t.index ["customer_id"], name: "customer_id"
  end

  create_table "sb_examinations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "ＳＢ審査情報", force: :cascade do |t|
    t.integer "sb_exam_request_id", comment: "ＳＢ審査依頼情報ID"
    t.integer "suggest_amount", comment: "限度額案"
    t.integer "fix_amount", comment: "決定限度額"
    t.string "pass_code", limit: 1, comment: "可決コード"
    t.string "reassurance_exist", limit: 1, comment: "再保険有無"
    t.integer "reassurance", comment: "再保険額"
    t.string "reassurance_gmo_exist", limit: 1, comment: "GMO再保険有無"
    t.integer "reassurance_gmo", comment: "GMO再保険額"
    t.string "tsr_code", limit: 11, comment: "TSRコード"
    t.string "tsr_attach", limit: 1, comment: "TSR添付"
    t.string "tsr_scoer", limit: 10, comment: "TSR点数"
    t.string "tsr_memo", comment: "TSR備考"
    t.string "tsr_doc_path", comment: "TSR資料パス"
    t.string "touki_memo", comment: "登記備考"
    t.string "touki_doc_path", comment: "登記資料パス"
    t.string "tdb_report", limit: 20, comment: "帝国情報"
    t.string "tdb_scoer", limit: 20, comment: "帝国点数"
    t.string "tdb_memo", comment: "帝国備考"
    t.string "tdb_doc_path", comment: "帝国資料パス"
    t.string "corp_number_memo", comment: "法人番号備考"
    t.string "bl_exist", limit: 1, comment: "BL情報有無"
    t.string "bl_info", comment: "BL情報"
    t.string "hp_type", limit: 1, comment: "ホームページ種別"
    t.string "hp_url", comment: "ホームページURL"
    t.string "special_note", comment: "特記事項"
    t.string "enrolled", limit: 30, comment: "在籍"
    t.date "answer_date", comment: "回答日"
    t.string "memo", comment: "メモ"
    t.datetime "created_at", null: false, comment: "登録日時"
    t.datetime "updated_at", null: false, comment: "更新日時"
    t.index ["sb_exam_request_id"], name: "sb_exam_request_id"
  end
  ...
  create_table "site_watchers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", comment: "サイトウォッチャー情報", force: :cascade do |t|
    ...
    t.index ["house_company_code"], name: "IDX_SW_HOUSE_COMPANY_CD"
  end
  ...
  add_foreign_key "companyinfo_entity_delete_lists", "entities", name: "companyinfo_entity_delete_lists_ibfk_1"
  add_foreign_key "corporate_registration_histories", "entities", name: "corporate_registration_histories_ibfk_1"
  ...
  add_foreign_key "crawler_filter_words", "customer_masters", name: "fk_cfw_customer_master_id"
  ...
  add_foreign_key "sb_exam_requests", "customers", name: "sb_exam_requests_ibfk_1"
  add_foreign_key "sb_examinations", "sb_exam_requests", name: "sb_examinations_ibfk_1"
